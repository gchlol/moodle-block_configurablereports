...
/**
 * Event triggered when configurable report is imported.
 *
...
class report_imported extends base {
    ...
    /**
     * Build event from a newly imported report record.
     *
     ...
     * @return static
     */
    public static function create_from_report(context $context, stdClass $report, string $source): base {
